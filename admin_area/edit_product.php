...
<?php 
    ...
    if(isset($_GET['edit_product'])){
        ...
        $p_videos = $row_edit['product_videos'];
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane fade in active" id="description">
                        <p class="product_description" name="product_desc" >
                          <?php echo $p_desc; ?>
                        </p>
                      </div>

                      <div class="tab-pane fade in " id="features">
                        <p class="product_features" name="product_features" >
                          <?php echo $p_features; ?>
                        </p>
                      </div>

                      <div class="tab-pane fade in" id="video">
                        <p class="product_video" name="product_vedios" >
                          <?php echo $p_videos; ?>
...
if(isset($_POST['update'])){
    ...
    $product_vedios = $_POST['product_vedios'];
