...
<?php 
                   ...
                   while($row_products=mysqli_fetch_array($run_products)){
                       ...
                       $pro_videos = $row_products['product_videos'];
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box" id="details"><!-- box Begin -->
                   ...
                   <p>
                    ...
                    <a data-toggle="tab" href="#description" class="btn btn-primary tab">Product Description</a>
                    <a data-toggle="tab" href="#features" class="btn btn-primary tab">Product Features</a>
                    <a data-toggle="tab" href="#video" class="btn btn-primary tab">Product Video</a>
